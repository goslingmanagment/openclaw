...
git rev-parse HEAD
git diff --exit-code 731d1556d38b382898acedd4a43d109a3e1b5228 HEAD -- . ':(exclude).github/workflows/codex-stream-memory-validation.yml' ':(exclude).github/diagnostics/stream-validation.sh' ':(exclude).github/diagnostics/check-short-write-red.py'
node --version
pnpm --version
